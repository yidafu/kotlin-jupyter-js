...
interface ClassPropertyBase : Node, HasSpan, HasDecorator {
    var value: Expression? var typeAnnotation: TsTypeAnnotation? var isStatic: Boolean? var accessibility: Accessibility? var isOptional: Boolean? var isOverride: Boolean? var readonly: Boolean? var definite: Boolean?
}
...
interface ClassMethodBase : Node, HasSpan {
    var function: Fn? var kind: MethodKind? var isStatic: Boolean? var accessibility: Accessibility? var isAbstract: Boolean? var isOptional: Boolean? var isOverride: Boolean?
}
...
interface Fn : HasSpan, HasDecorator {
    var params: Array<Param>? var body: BlockStatement? var generator: Boolean? var async: Boolean? var typeParameters: TsTypeParameterDeclaration? var returnType: TsTypeAnnotation?
}
