...
class DefaultJavaScriptProcessor(private val notebook: Notebook) {
    ...
    private fun executeJsCodeProcessor(program: Program, context: JavascriptProcessContext): JavascriptProcessContext {
    ...
    private fun executeJsxProcessor(program: Program, context: JavascriptProcessContext): JavascriptProcessContext {
    ...
    fun parseJsCode(source: String, context: JavascriptProcessContext): Program {
    ...
    private fun processJsCode(source: String, context: JavascriptProcessContext): String {
    ...
    internal fun transformTsCode(source: String, context: JavascriptProcessContext): Program {
    ...
    private fun processTsCode(source: String, context: JavascriptProcessContext): String {
    ...
    internal fun transformJsxCode(source: String, context: JavascriptProcessContext): Program {
        val transformOutput = swcCompiler.transformSync(
            source,
            false,
            options {
    ...
    private fun processJsxCode(source: String, context: JavascriptProcessContext): String {
    ...
    fun transformTsxCode(source: String, context: JavascriptProcessContext): Program {
        val transformOutput = swcCompiler.transformSync(
            source,
            false,
            options {
    ...
    private fun processTsxCode(source: String, context: JavascriptProcessContext): String {
    ...
    fun process(langType: JsMagicMatcher.LanguageType, sourceCode: String): String {
