...
object ErrorFormatter {
     ...
     */
    fun formatAsJson(error: JupyterJsError): String {
        return json.encodeToString(error)
    }
    ...
    private fun getErrorColor(error: JupyterJsError): String {
        return when (error) {
            is JupyterJsError.SyntaxError -> "#ff9800" // Orange
            is JupyterJsError.TypeError -> "#f44336" // Red
            is JupyterJsError.NetworkError -> "#2196f3" // Blue
            is JupyterJsError.VariableNotFoundError -> "#9c27b0" // Purple
            is JupyterJsError.ConfigurationError -> "#607d8b" // Blue-gray
            is JupyterJsError.CompilationError -> "#ff5722" // Deep orange
